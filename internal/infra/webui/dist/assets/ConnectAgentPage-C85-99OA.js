import{R as e,V as t,i as n,r,t as i}from"./Icon-3cBx3q4a.js";import{d as a,g as o,r as s}from"./index-Dt42jKTF.js";import{t as c}from"./Select-LBJlNAMB.js";var l=t(e(),1),u=`# Orako — ask a human before you guess
...
`,p=`ORAKO — ASK A HUMAN BEFORE YOU GUESS
...
`,m=`/assets/orako-ask-a-human-BMEfUMeG.skill`,h=r(),g={"claude-code":{label:`Claude Code`,register:e=>`claude mcp add --transport http orako ${e}`,authorize:`Run /mcp inside Claude Code to approve.`,note:`Usage: tools are called from natural language, and the Orako prompts also appear as slash commands — /mcp__orako__orako_answer (reply to the thread you were pinged on) and /mcp__orako__orako_sync (live back-and-forth). Reconnect /mcp after a server update to refresh them.`},codex:{label:`Codex`,register:e=>`codex mcp add orako --url ${e}`,authorize:`Run codex mcp login orako to approve.`,note:`Usage: Codex has no per-tool slash commands — drive Orako in natural language, e.g. “list my open orako conversations, then reply to the latest via follow_up: <message>”. Type /mcp in the Codex TUI to check the connection; if a thread doesn’t show up, ask it to check your other projects (list_projects).`},gemini:{label:`Gemini CLI`,register:e=>`gemini mcp add -t http orako ${e}`,authorize:`Run /mcp auth orako to approve.`},copilot:{label:`GitHub Copilot (CLI)`,register:e=>`copilot mcp add --transport http orako ${e}`,authorize:`Run copilot -i /mcp to approve.`},cursor:{label:`Cursor`,json:`.cursor/mcp.json`,path:`.cursor/mcp.json`,register:e=>`{
  "mcpServers": {
...
}`,authorize:`Approve in the browser — auto-prompted on first use.`,note:`Uses the generic mcp-remote npm proxy (not an Orako binary). Newer Windsurf builds have a native serverUrl field — prefer it if your version offers it.`}},_=[`claude-code`,`codex`,`gemini`,`copilot`,`cursor`,`vscode`,`windsurf`],v={"claude-desktop":{label:`Claude Desktop`,steps:[`Open Claude Desktop → profile picture → Settings → Connectors.`,`Click "Add" next to Connectors.`,`Paste the MCP URL above into the URL field and click "Add".`,`Click "Connect" and approve access in the browser tab that opens.`],plan:`Available on Free, Pro, Max, Team and Enterprise (Free is limited to one custom connector). Claude reaches your server over the public internet, so it needs a publicly reachable deployment.`},"claude-ai":{label:`Claude.ai (web)`,steps:[`Open claude.ai → Settings → Customize → Connectors.`,`Click the "+" next to Connectors, then "Add custom connector".`,`Paste the MCP URL above into the URL field and click "Add".`,`Click "Connect" and approve access in the browser tab that opens.`],plan:`Same Connectors UI as Claude Desktop, on Free, Pro, Max, Team and Enterprise (Free is limited to one custom connector).`},chatgpt:{label:`ChatGPT`,steps:[`Open ChatGPT → Plugins → Developer mode.`,`Enable Developer Mode (first time only).`,`Open Plugins → Browse Plugins, then click "+".`,`Name the connector, paste the MCP URL above, then connect and approve access.`],plan:`Requires a paid plan (Plus, Pro, Business, Enterprise or Edu). OpenAI flags Developer-mode connectors as able to take real actions on your behalf, so only connect servers you trust.`}},y=[`claude-desktop`,`claude-ai`,`chatgpt`],b={"claude-code":`skill`,codex:`agents`,gemini:`agents`,copilot:`agents`,cursor:`agents`,vscode:`agents`,windsurf:`agents`},x={background:n.surface,border:`1px solid ${n.border}`,borderRadius:n.rXl,overflow:`hidden`},S={background:`#1B1F2A`,borderRadius:11,padding:`14px 16px`},C={fontFamily:n.mono,fontSize:13,color:`#E4E7EC`},w={fontSize:11.5,fontWeight:600,letterSpacing:`.03em`,color:n.subtle},T={border:`1px solid ${n.accentBorder}`,background:n.surface,color:n.accentHover,borderRadius:9,padding:`9px 12px`,display:`inline-flex`,alignItems:`center`,gap:7,fontFamily:`inherit`,fontSize:12.5,fontWeight:650,cursor:`pointer`,textDecoration:`none`};function E({onCopy:e}){return(0,h.jsx)(`button`,{type:`button`,onClick:e,title:`Copy`,style:{border:`none`,background:`transparent`,padding:0,cursor:`pointer`,color:n.subtle,display:`inline-flex`,flex:`none`},children:(0,h.jsx)(i,{name:`copy`,size:15})})}function D({children:e,icon:t,onClick:n}){return(0,h.jsxs)(`button`,{type:`button`,onClick:n,style:T,children:[(0,h.jsx)(i,{name:t,size:14,strokeWidth:1.9}),e]})}function O({children:e}){return(0,h.jsx)(`pre`,{style:{...S,...C,margin:0,maxHeight:150,overflow:`hidden`,whiteSpace:`pre-wrap`,lineHeight:1.55,maskImage:`linear-gradient(to bottom, black 65%, transparent 100%)`,WebkitMaskImage:`linear-gradient(to bottom, black 65%, transparent 100%)`},children:e})}function k({n:e,title:t,mt:r=26}){return(0,h.jsxs)(`div`,{style:{marginTop:r,display:`flex`,alignItems:`center`,gap:10},children:[(0,h.jsx)(`span`,{style:{width:24,height:24,borderRadius:`50%`,background:n.accentSoft,color:n.accent,display:`flex`,alignItems:`center`,justifyContent:`center`,fontSize:13,fontWeight:700,flex:`none`},children:e}),(0,h.jsx)(`span`,{style:{fontSize:15.5,fontWeight:600,color:n.body},children:t})]})}function A({children:e}){return(0,h.jsxs)(`div`,{style:{display:`flex`,gap:10,alignItems:`flex-start`,background:n.warnBg,border:`1px solid ${n.warnBorder}`,borderRadius:11,padding:`12px 14px`},children:[(0,h.jsx)(i,{name:`alertTriangle`,size:16,color:n.warn,strokeWidth:1.9,style:{flex:`none`,marginTop:1}}),(0,h.jsx)(`p`,{style:{fontSize:12.5,lineHeight:1.55,color:n.warn,margin:0},children:e})]})}function j({active:e,onSelect:t,title:r,desc:i,badge:a}){return(0,h.jsxs)(`button`,{onClick:t,style:{textAlign:`left`,cursor:`pointer`,padding:`16px 17px`,borderRadius:14,background:n.surface,display:`flex`,flexDirection:`column`,gap:6,transition:`all .15s`,border:e?`2px solid ${n.accent}`:`1px solid ${n.borderStrong}`,boxShadow:e?n.shadowPop:`none`,fontFamily:`inherit`},children:[(0,h.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:9},children:[(0,h.jsx)(`span`,{style:{width:18,height:18,borderRadius:`50%`,flex:`none`,border:e?`5px solid ${n.accent}`:`2px solid #C7CBD4`,background:e?n.accent:`transparent`}}),(0,h.jsx)(`span`,{style:{fontSize:14.5,fontWeight:700,color:n.text},children:r}),a&&(0,h.jsx)(`span`,{style:{marginLeft:`auto`,fontSize:10.5,fontWeight:700,letterSpacing:`.04em`,color:n.accentHover,background:n.accentSoft,border:`1px solid ${n.accentBorder}`,padding:`3px 7px`,borderRadius:6},children:a})]}),(0,h.jsx)(`p`,{style:{fontSize:13,lineHeight:1.5,color:n.muted,paddingLeft:27,margin:0},children:i})]})}function M(){return(0,h.jsxs)(s,{width:760,children:[(0,h.jsx)(`h2`,{style:{fontSize:27,fontWeight:700,letterSpacing:`-.025em`,color:`#12141B`},children:`Connect your agent to Orako`}),(0,h.jsx)(`p`,{style:{fontSize:15,lineHeight:1.6,color:n.muted,marginTop:9,maxWidth:640},children:`Point your coding agent — or Claude Desktop, ChatGPT — at Orako and authorize once. It gets your team's knowledge and teammates on tap. You authorize inside the agent; there's no token to copy.`}),(0,h.jsx)(N,{})]})}function N(){let e=a(),[t,r]=(0,l.useState)(`terminal`),[o,s]=(0,l.useState)(`claude-code`),[M,N]=(0,l.useState)(`claude-desktop`),[F,I]=(0,l.useState)(!1),[L,R]=(0,l.useState)(!1),z=`${window.location.origin}/mcp`,B=t===`terminal`,V=g[o]??g[`claude-code`],H=v[M]??v[`claude-desktop`],U=B?V.label:H.label,W=B?b[o]??`agents`:`mcp`;async function G(t){try{await navigator.clipboard.writeText(t),e.success(`Copied`)}catch{e.error(`Copy failed`)}}return(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(k,{n:1,title:`How do you want to connect?`,mt:34}),(0,h.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`1fr 1fr`,gap:14,marginTop:14},children:[(0,h.jsx)(j,{active:B,onSelect:()=>r(`terminal`),title:`In my terminal / IDE`,badge:`RECOMMENDED`,desc:`For developers. The CLI registers the remote server for you.`}),(0,h.jsx)(j,{active:!B,onSelect:()=>r(`noterminal`),title:`No terminal`,desc:`Claude Desktop, Claude.ai, ChatGPT — connect from the app's settings with a URL.`})]}),(0,h.jsx)(k,{n:2,title:`Which client?`}),(0,h.jsx)(`div`,{style:{marginTop:13,maxWidth:340},children:B?(0,h.jsx)(c,{value:o,onChange:e=>s(e.target.value),style:{height:46,fontWeight:600},children:_.map(e=>(0,h.jsx)(`option`,{value:e,children:g[e].label},e))}):(0,h.jsx)(c,{value:M,onChange:e=>N(e.target.value),style:{height:46,fontWeight:600},children:y.map(e=>(0,h.jsx)(`option`,{value:e,children:v[e].label},e))})}),(0,h.jsx)(k,{n:3,title:`Set up ${U}`}),B?(0,h.jsxs)(`div`,{style:{...x,marginTop:14},children:[(0,h.jsxs)(`div`,{style:{padding:`16px 20px`,background:n.surfaceAlt,borderBottom:`1px solid ${n.borderSubtle}`,display:`flex`,gap:11,alignItems:`flex-start`},children:[(0,h.jsx)(i,{name:`zap`,size:18,color:n.accent,strokeWidth:1.9,style:{flex:`none`,marginTop:1}}),(0,h.jsxs)(`p`,{style:{fontSize:13.5,lineHeight:1.55,color:`#3A414D`,margin:0},children:[`Register Orako’s MCP URL, then approve access in `,U,`. The tools are available immediately after authorization.`]})]}),(0,h.jsxs)(`div`,{style:{padding:`22px 22px 24px`,display:`flex`,flexDirection:`column`,gap:18},children:[(0,h.jsxs)(`div`,{children:[(0,h.jsxs)(`div`,{style:{...w,marginBottom:7},children:[`REGISTER`,V.path&&(0,h.jsxs)(h.Fragment,{children:[` · `,(0,h.jsx)(`span`,{style:{fontFamily:n.mono,color:n.muted,letterSpacing:0},children:V.path})]})]}),(0,h.jsxs)(`div`,{style:{...S,display:`flex`,alignItems:`flex-start`,gap:12},children:[(0,h.jsxs)(`code`,{style:{...C,fontSize:12.5,flex:1,overflowX:`auto`,whiteSpace:V.json?`pre`:`nowrap`,lineHeight:1.6},children:[!V.json&&(0,h.jsx)(`span`,{style:{color:n.subtle},children:`$ `}),V.register(z)]}),(0,h.jsx)(E,{onCopy:()=>void G(V.register(z))})]}),V.note&&(0,h.jsx)(`p`,{style:{fontSize:12,lineHeight:1.5,color:n.faint,margin:`8px 0 0`},children:V.note}),(0,h.jsx)(`div`,{style:{...w,margin:`16px 0 7px`},children:`AUTHORIZE`}),(0,h.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:10,background:n.bg,border:`1px solid ${n.borderSubtle}`,borderRadius:10,padding:`11px 14px`},children:[(0,h.jsx)(i,{name:`lock`,size:16,color:n.accent,strokeWidth:1.9,style:{flex:`none`}}),(0,h.jsx)(`span`,{style:{fontSize:13.5,color:`#3A414D`},children:V.authorize})]})]}),(0,h.jsx)(A,{children:`MCP always exposes the tools. Some clients also relay Orako's server instructions to the model; the next step reinforces the workflow where that behavior is not guaranteed.`})]})]}):(0,h.jsxs)(`div`,{style:{...x,marginTop:14},children:[(0,h.jsxs)(`div`,{style:{padding:`16px 20px`,background:n.surfaceAlt,borderBottom:`1px solid ${n.borderSubtle}`,display:`flex`,gap:11,alignItems:`flex-start`},children:[(0,h.jsx)(i,{name:`shield`,size:18,color:n.accent,strokeWidth:1.9,style:{flex:`none`,marginTop:1}}),(0,h.jsxs)(`p`,{style:{fontSize:13.5,lineHeight:1.55,color:`#3A414D`,margin:0},children:[(0,h.jsx)(`strong`,{style:{color:n.text},children:`No install, no config file.`}),` These apps add a remote MCP server from their own settings: paste one URL, connect, approve in your browser. You get Orako's tools and their built-in descriptions.`]})]}),(0,h.jsxs)(`div`,{style:{padding:22,display:`flex`,flexDirection:`column`,gap:20},children:[(0,h.jsxs)(`div`,{children:[(0,h.jsx)(`div`,{style:{...w,marginBottom:7},children:`THE ONLY URL — SAME EVERYWHERE`}),(0,h.jsxs)(`div`,{style:{...S,display:`flex`,alignItems:`center`,gap:12},children:[(0,h.jsx)(`code`,{style:{...C,fontSize:13.5,flex:1,overflowX:`auto`,whiteSpace:`nowrap`},children:z}),(0,h.jsx)(E,{onCopy:()=>void G(z)})]})]}),(0,h.jsxs)(`div`,{children:[(0,h.jsxs)(`div`,{style:{fontSize:14.5,fontWeight:600,color:n.body,marginBottom:12},children:[`Steps in `,U]}),(0,h.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`},children:H.steps.map((e,t)=>(0,h.jsxs)(`div`,{style:{display:`flex`,gap:13,alignItems:`flex-start`,paddingBottom:14},children:[(0,h.jsx)(`span`,{style:{width:24,height:24,borderRadius:7,background:n.accentSoft,color:n.accent,display:`flex`,alignItems:`center`,justifyContent:`center`,fontSize:12.5,fontWeight:700,flex:`none`},children:t+1}),(0,h.jsx)(`span`,{style:{fontSize:13.5,lineHeight:1.5,color:`#3A414D`,paddingTop:2},children:e})]},t))})]}),(0,h.jsxs)(A,{children:[H.plan,` The exact menu wording and plan requirement change often — if your plan can't add a custom connector, you'll see it there rather than hunting.`]})]})]}),(0,h.jsx)(P,{resource:z,onStatusChange:R}),!L&&(0,h.jsx)(`div`,{style:{marginTop:14,padding:`12px 15px`,borderRadius:12,border:`1px dashed ${n.borderStrong}`,background:n.surfaceAlt,color:n.muted,fontSize:13,lineHeight:1.5},children:`The optional agent playbook appears after Orako confirms at least one authorization.`}),(0,h.jsxs)(`div`,{style:{display:L?`contents`:`none`},"aria-hidden":!L,children:[(0,h.jsx)(k,{n:4,title:`Teach your agent the Orako loop`}),(0,h.jsxs)(`div`,{style:{...x,marginTop:14},children:[(0,h.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`1fr 1fr`,background:n.surfaceAlt,borderBottom:`1px solid ${n.borderSubtle}`},children:[(0,h.jsxs)(`div`,{style:{padding:`15px 18px`,borderRight:`1px solid ${n.borderSubtle}`},children:[(0,h.jsx)(`div`,{style:{...w,color:n.accent},children:`TOOLS`}),(0,h.jsx)(`div`,{style:{fontSize:13.5,fontWeight:650,color:n.body,marginTop:4},children:`Automatic over MCP`}),(0,h.jsx)(`p`,{style:{fontSize:12,lineHeight:1.5,color:n.muted,margin:`4px 0 0`},children:`Search, ask, follow up, and resolve are available after authorization.`})]}),(0,h.jsxs)(`div`,{style:{padding:`15px 18px`},children:[(0,h.jsx)(`div`,{style:{...w,color:n.accent},children:`PLAYBOOK`}),(0,h.jsx)(`div`,{style:{fontSize:13.5,fontWeight:650,color:n.body,marginTop:4},children:`Client-dependent`}),(0,h.jsx)(`p`,{style:{fontSize:12,lineHeight:1.5,color:n.muted,margin:`4px 0 0`},children:`This locks in search-first, one-thread, and distilled resolution.`})]})]}),(0,h.jsxs)(`div`,{style:{padding:22},children:[(0,h.jsx)(`div`,{role:`group`,"aria-label":`Agent guidance format`,style:{display:`inline-flex`,padding:3,gap:3,borderRadius:10,background:n.bg,border:`1px solid ${n.borderSubtle}`,marginBottom:18},children:[{active:!F,label:`For ${U}`,onClick:()=>I(!1)},{active:F,label:`Custom / headless`,onClick:()=>I(!0)}].map(e=>(0,h.jsx)(`button`,{type:`button`,onClick:e.onClick,"aria-pressed":e.active,style:{border:`none`,borderRadius:7,padding:`7px 11px`,background:e.active?n.surface:`transparent`,boxShadow:e.active?n.shadowCard:`none`,color:e.active?n.text:n.muted,fontFamily:`inherit`,fontSize:12.5,fontWeight:e.active?650:500,cursor:`pointer`},children:e.label},e.label))}),F?(0,h.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:14},children:[(0,h.jsxs)(`div`,{children:[(0,h.jsx)(`div`,{style:{fontSize:15,fontWeight:700,color:n.text},children:`Paste into your system prompt`}),(0,h.jsxs)(`p`,{style:{fontSize:13,lineHeight:1.55,color:n.muted,margin:`5px 0 0`,maxWidth:620},children:[`For Hermes, CI, or a custom agent loop. If it does not speak MCP, also copy the Connect-JSON recipes and mint a scoped token in `,(0,h.jsx)(`a`,{href:`/machine-tokens`,style:{color:n.accentHover},children:`Settings → Machine tokens`}),`.`]})]}),(0,h.jsx)(O,{children:p}),(0,h.jsxs)(`div`,{style:{display:`flex`,flexWrap:`wrap`,gap:9},children:[(0,h.jsx)(D,{icon:`copy`,onClick:()=>void G(p),children:`Copy system prompt`}),(0,h.jsx)(D,{icon:`copy`,onClick:()=>void G(d),children:`Copy Connect-JSON recipes`})]})]}):W===`skill`?(0,h.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:14},children:[(0,h.jsxs)(`div`,{children:[(0,h.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:8},children:[(0,h.jsx)(`span`,{style:{fontSize:15,fontWeight:700,color:n.text},children:`Already delivered by Claude Code`}),(0,h.jsx)(`span`,{style:{...w,color:n.accent,background:n.accentSoft,borderRadius:5,padding:`3px 6px`},children:`OPTIONAL`})]}),(0,h.jsx)(`p`,{style:{fontSize:13,lineHeight:1.55,color:n.muted,margin:`5px 0 0`,maxWidth:620},children:`Claude Code relays Orako's MCP instructions. Install the skill only if you want stronger triggering when a task reaches a human-only decision.`})]}),(0,h.jsxs)(`div`,{style:{display:`flex`,flexWrap:`wrap`,gap:9},children:[(0,h.jsx)(D,{icon:`copy`,onClick:()=>void G(f),children:`Copy SKILL.md`}),(0,h.jsxs)(`a`,{href:m,download:`orako-ask-a-human.skill`,style:T,children:[(0,h.jsx)(i,{name:`download`,size:14,strokeWidth:1.9}),`Download .skill`]})]})]}):W===`agents`?(0,h.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:14},children:[(0,h.jsxs)(`div`,{children:[(0,h.jsx)(`div`,{style:{fontSize:15,fontWeight:700,color:n.text},children:`Add this to your project's AGENTS.md`}),(0,h.jsxs)(`p`,{style:{fontSize:13,lineHeight:1.55,color:n.muted,margin:`5px 0 0`,maxWidth:620},children:[`MCP provides the tools. Project guidance guarantees the search-first workflow even when `,U,` `,`does not relay the server's instruction block.`]})]}),(0,h.jsx)(O,{children:u}),(0,h.jsx)(`div`,{children:(0,h.jsx)(D,{icon:`copy`,onClick:()=>void G(u),children:`Copy AGENTS.md guidance`})})]}):(0,h.jsxs)(`div`,{children:[(0,h.jsx)(`div`,{style:{fontSize:15,fontWeight:700,color:n.text},children:`No extra file to install`}),(0,h.jsxs)(`p`,{style:{fontSize:13,lineHeight:1.55,color:n.muted,margin:`5px 0 0`,maxWidth:620},children:[U,` receives the Orako tools and their descriptions through MCP. Use the custom/headless tab only if your client gives you a place to add persistent instructions.`]})]})]})]}),(0,h.jsx)(k,{n:5,title:`Did it work?`}),(0,h.jsxs)(`div`,{style:{marginTop:13,background:n.accentSofter,border:`1px solid ${n.accentBorder}`,borderRadius:14,padding:`16px 18px`,display:`flex`,gap:12,alignItems:`flex-start`},children:[(0,h.jsx)(i,{name:`message`,size:19,color:n.accent,strokeWidth:1.9,style:{flex:`none`,marginTop:1}}),(0,h.jsxs)(`p`,{style:{fontSize:13.5,lineHeight:1.6,color:`#3A414D`,margin:0},children:[`There's nothing to test here — Orako runs inside your agent, not the dashboard. Open your agent and ask it to use an Orako tool: `,(0,h.jsx)(`em`,{style:{color:n.accentHover},children:`"search Orako for the refund policy"`}),` or`,` `,(0,h.jsx)(`em`,{style:{color:n.accentHover},children:`"list the teammates on this project."`}),` If it answers, you're connected. If it says the server needs authentication, run its authorize step (e.g.`,` `,(0,h.jsx)(`code`,{style:{fontFamily:n.mono,fontSize:12,background:n.accentSoft,color:n.accentHover,padding:`1px 6px`,borderRadius:5},children:`/mcp`}),` `,`in Claude Code).`]})]})]})]})}function P({resource:e,onStatusChange:t}){let[r,a]=(0,l.useState)([]),[s,c]=(0,l.useState)(!0),[u,d]=(0,l.useState)(!1),f=(0,l.useCallback)(async()=>{d(!1);try{let t=await o.listMcpConnections();a((t.connections??[]).filter(t=>t.resource===e))}catch{d(!0)}finally{c(!1)}},[e]);(0,l.useEffect)(()=>(f(),window.addEventListener(`focus`,f),()=>window.removeEventListener(`focus`,f)),[f]),(0,l.useEffect)(()=>{t?.(r.length>0)},[r.length,t]);let p=(0,l.useMemo)(()=>[...r].sort((e,t)=>(t.connectedAt??``).localeCompare(e.connectedAt??``)),[r]),m=(0,l.useMemo)(()=>[...new Set(p.map(e=>e.clientName||`MCP client`))],[p]),g=m.length>1?`${m[0]} and ${m.length-1} more`:m[0],_=p.length>0;return(0,h.jsxs)(`div`,{style:{marginTop:14,border:`1px solid ${_?n.successBorder:n.border}`,background:_?n.successBg:n.surface,borderRadius:12,padding:`13px 15px`,display:`flex`,alignItems:`center`,gap:11},children:[(0,h.jsx)(i,{name:_?`check`:`refresh`,size:17,color:_?n.success:n.subtle,strokeWidth:2.2}),(0,h.jsxs)(`div`,{style:{flex:1},children:[(0,h.jsx)(`div`,{style:{fontSize:13.5,fontWeight:700,color:_?n.successInk:n.text},children:_?`${p.length} authorization${p.length===1?``:`s`} confirmed`:s?`Checking authorization…`:`Waiting for authorization`}),(0,h.jsx)(`div`,{title:m.join(`, `),style:{marginTop:2,fontSize:12,color:_?n.successInk:n.muted},children:_?`${g} can access Orako.`:u?`Could not check right now. Your agent may still be connected.`:`Authorize in your agent, then return to this tab.`})]}),(0,h.jsx)(`button`,{type:`button`,onClick:()=>{c(!0),f()},style:{border:`1px solid ${_?n.successBorder:n.borderStrong}`,background:n.surface,color:_?n.successInk:n.body,borderRadius:8,padding:`7px 10px`,fontFamily:`inherit`,fontSize:12,fontWeight:600,cursor:`pointer`},children:`Check again`})]})}export{N as ConnectAgent,M as ConnectAgentPage};